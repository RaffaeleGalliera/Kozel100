...
ALTER TABLE `contact_person` CHANGE `email` `email` VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, CHANGE `phone_number` `phone_number` VARCHAR(13) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, CHANGE `company_id` `company_id` INT(11) NOT NULL; 
...
ALTER TABLE `user` CHANGE `first_name` `first_name` VARCHAR(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL, CHANGE `last_name` `last_name` VARCHAR(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL, CHANGE `recruitment_date` `recruitment_date` DATE NOT NULL, CHANGE `end_working` `end_working` DATE NOT NULL, CHANGE `phone_number` `phone_number` VARCHAR(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL, CHANGE `position_id` `position_id` INT(11) NOT NULL, CHANGE `work_field_id` `work_field_id` INT(11) NOT NULL, CHANGE `is_admin` `is_admin` TINYINT(1) NOT NULL DEFAULT '0';
